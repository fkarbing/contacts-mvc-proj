...
/**
 * Tests all the ConsultantSkillController<ConsultantSkill> methods using the
 * {@link MockMvc} object.
 * 
...
public class ConsultantSkillControllerMockMvcStandaloneTest {

	private static Logger LOG = LoggerFactory
	        .getLogger(ConsultantSkillControllerMockMvcStandaloneTest.class);

	// Resource path
	private final String resourcePath = MvcControllerUtil.resourcePath(ConsultantSkill.class);
	...
	@Before
	public void before() {
		mockMvc = MockMvcBuilders.standaloneSetup(consultantSkillController).build();
	}


	// TODO: verify consultantSkill!
	@Test
	...
	public void testCreateInvalidModel() throws Exception {
		...
		ConsultantSkill consultantSkill = new ConsultantSkill(null, null);
		String json = JackSONUtils.toJSON(consultantSkill);
		LOG.info("consultantSkill json: " + json);
	...
	public void testUpdate() throws Exception {
		...
		// Create item
		ConsultantSkill storedItem = _postMockModel();
		...
		LOG.info("consultantSkill putJsonStr: " + putJsonStr + " resourcePathWithId: "
		        + resourcePathWithId);
		...
		ConsultantSkill updatedItem = ResultActionsUtil.contentAsJson(resultActions,
	...
	// TODO: Get consultantSkill from Response and use that id!
	@Test
	public void testFetch() throws Exception {
		...
		ConsultantSkill fetchedItem = ResultActionsUtil.contentAsJson(resultActions,
		        ConsultantSkill.class);
	...
	public void testFetchAll() throws Exception {
		...
		// Create 3
		for (int i = 0; i < 3; i++) {
			String json = JackSONUtils.toJSON(new ConsultantSkill(null, "karbing"));
			LOG.info("consultantSkill json: " + json);
	...
	public void testRemove() throws Exception {
		...
		ConsultantSkill removedItem = ResultActionsUtil.contentAsJson(resultActions,
		        ConsultantSkill.class);
	 ...
	 * @throws Exception
	 */
	private ConsultantSkill _postMockModel() throws Exception {
		String jsonStr = JackSONUtils.toJSON(ConsultantSkillMock.newIntance());
		LOG.info("consultantSkill json: " + jsonStr);
		// Post request
		...
		ConsultantSkill storedItem = ResultActionsUtil.contentAsJson(resultActions,
		        ConsultantSkill.class);
