...
/**
 * Tests all the MyModelController<MyModel> methods using the {@link MockMvc}
 * object.
 * 
...
public class MyModelControllerMockMvcStandaloneTest {

	private static Logger LOG = LoggerFactory
	        .getLogger(MyModelControllerMockMvcStandaloneTest.class);

	// Resource path
	private final String resourcePath = MvcControllerUtil.resourcePath(MyModel.class);

	@Autowired
	private MyModelController myModelController;
	/*
	 * @Autowired private RESTInterceptor restInterceptor;
	 */
	...
	@Before
	public void before() {
		mockMvc = MockMvcBuilders.standaloneSetup(myModelController).build();
	}
	...
	public void testCreateInvalidModel() throws Exception {
		...
		MyModel myModel = new MyModel(null, null);
		String json = JackSONUtils.toJSON(myModel);
		LOG.info("myModel json: " + json);
	...
	public void testUpdate() throws Exception {
		...
		// Create item
		MyModel storedItem = _postMockModel();
		...
		LOG.info("myModel putJsonStr: " + putJsonStr + " resourcePathWithId: " + resourcePathWithId);
		...
		MyModel updatedItem = ResultActionsUtil.contentAsJson(resultActions, MyModel.class);
	...
	public void testFetch() throws Exception {
		...
		MyModel fetchedItem = ResultActionsUtil.contentAsJson(resultActions, MyModel.class);
	...
	public void testFetchAll() throws Exception {
		...
		// Create 3
		for (int i = 0; i < 3; i++) {
			String json = JackSONUtils.toJSON(new MyModel(null, "karbing"));
			LOG.info("myModel json: " + json);
	...
	public void testRemove() throws Exception {
		...
		MyModel removedItem = ResultActionsUtil.contentAsJson(resultActions, MyModel.class);
	 ...
	 * @throws Exception
	 */
	private MyModel _postMockModel() throws Exception {
		String jsonStr = JackSONUtils.toJSON(MyModelMock.newIntance());
		LOG.info("myModel json: " + jsonStr);
		// Post request
		...
		MyModel storedItem = ResultActionsUtil.contentAsJson(resultActions, MyModel.class);
