...
/**
 * Tests all the LocationController<Location> methods using the {@link MockMvc}
 * object.
 * 
...
public class LocationControllerMockMvcStandaloneTest {
	...
	private static Logger LOG = LoggerFactory
	        .getLogger(LocationControllerMockMvcStandaloneTest.class);
	...
	public void testUpdate() throws Exception {
		...
		LOG.info("location putJsonStr: " + putJsonStr + " resourcePathWithId: "
		        + resourcePathWithId);
