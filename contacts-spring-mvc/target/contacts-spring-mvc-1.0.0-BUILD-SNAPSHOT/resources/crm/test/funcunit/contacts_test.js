...
test("Filtering", function(){
	...
	S(".consultantskill:first").visible().click();
...
test("Creating a Category", function(){
	S(".consultantskill").visible(function(){
		equals(S(".consultantskill").size(), 7, "7 categories")
	})
	S("#consultantskill .createbutton").exists().click();
	S("#consultantskill input").visible().click().type("\b\b\b\bBasketball\r");
	S(".consultantskill").size(8, function(){
